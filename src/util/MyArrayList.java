...
public class MyArrayList<T> implements MyList<T> {
    ...
    public MyArrayList(T[] values) {// провереть как поломаеться, если не изменить тиа массива в параметрах конструктора
...
//        System.out.println("Расширяем массив! ================= " + cursor);
    ...
    public T[] toArray() {
        ...
        // 1. Создать массив нудной длинны и типа
...
//        return result;
    ...
    public T remove(int index) {
        ...
        // значениями из соседней ячейки с права
